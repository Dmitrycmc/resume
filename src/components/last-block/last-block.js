...
const LastBlock = ({ innerRef }) => (
    <Container ref={innerRef}>
        ...
        <Article>
            ...
            <Line>Выполняю задачи в срок. Без лишних вопросов. Иду к тому, чтобы брать full stack задачи целиком.</Line>
            <Line>Языки программирования: JS, Java, C</Line>
            <Line>Опыт: JS, React, Redux, MobX, Java, Node, Express, Spring, SQL, Mongo, NPM, Maven, hbs</Line>
            <Line>Проводил собеседования, руководил командой, декомпозировал и распараллеливал задачи</Line>
            <Line>VCS: Git</Line>
        </Article>
    </Container>
);
